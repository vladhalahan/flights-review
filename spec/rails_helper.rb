...
# This sets paper_trail to be off by default, which can speed up testing.
# To enable paper_trail for testing, use 'with_versioning' or 'versioning: true' in the tests that require it, e.g.
